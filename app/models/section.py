...
class Section(Base):
    ...
    section_exclusive_contents = relationship("SectionExclusiveContent", back_populates="section", cascade="all, delete")
    
    assignments = relationship("Assignment", back_populates="section", cascade="all, delete")
    
    student_stats = relationship("StudentStats", back_populates="section", cascade="all, delete")
